...
actI.textContent = "※ Welcome, " + uname + "! ※";actC.style.display = "block";lCD.style.display = "none";sCD.style.display = "none";orb.style.display = "none";sSUP.parentElement.style.display = "none";sLG.style.display = "none";btnGL.style.display = "none";gUD.style.display = "none";document.querySelector("h2").style.display = "none";
// google users can't change email/password, those are managed by google
...
btnStOpen.onclick = () => { actC.style.display = "none"; stPanel.style.display = "block"; stUNMsg.textContent = ""; stEMMsg.textContent = ""; stPAMsg.textContent = ""; stNewUN.value = ""; stNewEM.value = ""; stCurPAem.value = ""; stCurPA.value = ""; stNewPA.value = ""; stCOPA.value = ""; };
