...
const firebaseConfig = {apiKey:_a,authDomain:_b,databaseURL:_c,projectId:_d,storageBucket:_e,messagingSenderId:_f,appId:_g,measurementId:_h};firebase.initializeApp(firebaseConfig);const appCheck=firebase.appCheck();appCheck.activate("NkxjU1RDd3RBQUFBQUUyZEZ4VHBzUVI1ZnJTdjRNTEdNd3VyUzhwRQ",true);const db = firebase.database();const auth = firebase.auth();let resolveAuthReady;const authReady = new Promise(res => { resolveAuthReady = res; });let checkedInitialAuth = false;
