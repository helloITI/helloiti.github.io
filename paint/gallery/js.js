...
firebase.initializeApp(firebaseConfig);firebase.appCheck().activate(new firebase.appCheck.ReCaptchaV3Provider("NkxjU1RDd3RBQUFBQUUyZEZ4VHBzUVI1ZnJTdjRNTEdNd3VyUzhwRQ"),true);const db = firebase.database();const auth = firebase.auth();const $ = id => document.getElementById(id);let checkedInitialAuth = false;
