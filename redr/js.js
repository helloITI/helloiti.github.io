const fE=document.getElementById('file'),oC=document.getElementById('orig'),uC=document.getElementById('out'),cO=oC.getContext('2d',{willReadFrequently:true}),cU=uC.getContext('2d');const mE=document.getElementById('mode'),hRE=document.getElementById('hueRange'),sME=document.getElementById('satMin'),vME=document.getElementById('valMin'),sE=document.getElementById('soft'),rBE=document.getElementById('redBoost'),dB=document.getElementById('download'),rB=document.getElementById('reset'),mu=document.getElementById('bgm');
let img=new Image();
