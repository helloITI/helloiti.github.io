...
if (bf.includes('mii')) { mu.src = 'https://helloiti.github.io/assets/seal_song.mp3'; mu.loop = true; mu.play().catch(() => {}); bf = ''; 
...
document.addEventListener("click", function pm() { mu.play().catch(err => {}); document.removeEventListener("click", pm); });
